...
-- AddForeignKey
ALTER TABLE "formulario_tipos" ADD CONSTRAINT "formulario_tipos_rutaId_fkey" FOREIGN KEY ("rutaId") REFERENCES "Rutas"("id_ruta") ON DELETE SET NULL ON UPDATE CASCADE;
